from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QWidget, QLabel, QStackedWidget, QGridLayout, QHBoxLayout, QSpacerItem, QSizePolicy, QSpinBox, QComboBox, QMessageBox
from PyQt5.QtGui import QFont, QFontMetrics
from PyQt5.QtCore import Qt, pyqtSignal, QPoint
import pet
import threading
from face_detection_widget import FaceDetectionWidget  # 导入 FaceDetectionWidget
...
class MainWindow(QMainWindow):
    ...
    def pet(self):
        ...
        self.end_button = QPushButton('回收宠物')
        self.end_button.clicked.connect(pet.destroy)
